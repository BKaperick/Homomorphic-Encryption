...
\begin{lemma}
    ...
    \[\rho \leq \frac{1}{2}\left( \log_2(s-1) - \log_2(4\tau+5) -1 \right)\]
    then 
    \[
        q_{x_0}(c)r_s(x_0) \in \left(-\frac{s-1}{2}, \frac{s-1}{2}\right].\]
    \label{bound}
\end{lemma}

\begin{proof}
    Assume $\rho \leq \frac{1}{2}\left( \log_2(s-1) - \log_2(4\tau+5) -1 \right)$ is given.  
    The following are all equivalent,
\begin{align*}
    \rho &\leq \frac{1}{2}\left( \log_2(s-1) - \log_2(4\tau+5) -1 \right)\\
    2\rho &\leq \log_2 \left( \frac{s-1}{2(4\tau+5)} \right)\\
    (4\tau+5) 2^{2\rho} &< \frac{s-1}{2}.
\end{align*}

Decompose $x_0$ into $x_0 = c_0s+r_0$, $c_0,r_0\in\Z$ with $r_0\in (-2^\rho,2^\rho)$ and let $m\in\{0,1\}$ be arbitrary.
